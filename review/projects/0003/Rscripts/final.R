dat <- read.csv("/users/vsm263/project/client2outputs/2_cubic_output.txt")
...
dat <- read.csv("/users/vsm263/project/client1outputs/1_hs_cubic_output.txt")
cnames <- c("time", "srcip", "srcport", "dstip", 
            "dstport", "id", "interval", "data", 
            "tput")
names(dat) <- cnames
...
dat <- read.csv("/users/vsm263/project/client2outputs/2_scalable_output.txt")
cnames <- c("time", "srcip", "srcport", "dstip", 
            "dstport", "id", "interval", "data", 
            "tput")
names(dat) <- cnames
...
dat <- read.csv("/users/vsm263/project/client1outputs/1_hs_scalable_output.txt")
cnames <- c("time", "srcip", "srcport", "dstip", 
            "dstport", "id", "interval", "data", 
            "tput")
names(dat) <- cnames
...
dat <- read.csv("/users/vsm263/project/client2outputs/1_reno_output.txt")
cnames <- c("time", "srcip", "srcport", "dstip", 
            "dstport", "id", "interval", "data", 
            "tput")
names(dat) <- cnames
...
dat <- read.csv("/users/vsm263/project/client1outputs/1_hs_reno_output.txt")
cnames <- c("time", "srcip", "srcport", "dstip", 
            "dstport", "id", "interval", "data", 
            "tput")
names(dat) <- cnames
