dat2 <- read.csv("el6383-project/Throughput/Throughput_TCP_1G_50ms_20KB.txt")
str(dat2)
...
dat2 <- read.csv("el6383-project/Throughput/Throughput_TCP_1G_50ms_40KB.txt")
names(dat2) <- cnames
dat2$Packet <- 40000
dat2$bandwidth <- 1000000000
dat2$flowtype <- "TCP"
...
dat2 <- read.csv("el6383-project/Throughput/Throughput_TCP_1G_50ms_60KB.txt")
names(dat2) <- cnames
dat2$Packet <- 60000
dat2$bandwidth <- 1000000000
dat2$flowtype <- "TCP"
...
dat2 <- read.csv("el6383-project/Throughput/Throughput_UDP_1G_50ms_20KB.txt")
names(dat2) <- cnames
dat2$Packet <- 20000
dat2$bandwidth <- 1000000000
dat2$flowtype <- "UDP"
...
dat2 <- read.csv("el6383-project/Throughput/Throughput_UDP_1G_50ms_40KB.txt")
names(dat2) <- cnames
dat2$Packet <- "40000"
dat2$bandwidth <- 1000000000
dat2$flowtype <- "UDP"
...
dat2 <- read.csv("el6383-project/Throughput/Throughput_UDP_1G_50ms_60KB.txt")
names(dat2) <- cnames
dat2$Packet <- 60000
dat2$bandwidth <- 1000000000
dat2$flowtype <- "UDP"
...
q2
ggsave("Throughput_TCP_UDP_1G_50ms.png", plot=q2)
